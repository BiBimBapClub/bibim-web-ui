      ...
      <FlexBox>
        <NavRow justify="start">
          ...
          <NavCol
            span={3}
            offset={8}
            onMouseOver={() => setCheckHovering(1)}
          ...
          <NavCol
            span={3}
            onMouseOver={() => setCheckHovering(2)}
            onMouseOut={() => setCheckHovering(0)}
          >
            동아리 소개
          </NavCol>
          <NavCol
            span={3}
            onMouseOver={() => setCheckHovering(3)}
            onMouseOut={() => setCheckHovering(0)}
          >
            동아리 활동
          </NavCol>
          <NavCol
            span={3}
            onMouseOver={() => setCheckHovering(4)}
            onMouseOut={() => setCheckHovering(0)}
          >
            후기
          </NavCol>
          <NavCol
            span={3}
            onMouseOver={() => setCheckHovering(5)}
            onMouseOut={() => setCheckHovering(0)}
          >
            정보 광장
          </NavCol>
